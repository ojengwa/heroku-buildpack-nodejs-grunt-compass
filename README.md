...
For more technical details, see the [heavily-commented compile script](https://github.com/ojengwa/heroku-buildpack-nodejs-grunt-sass/blob/master/bin/compile).
...
Create a new app with this buildpack:
    ...
    heroku create myapp --buildpack heroku config:add BUILDPACK_URL=https://github.com/ojengwa/heroku-buildpack-nodejs-grunt-sass.git

Or add this buildpack to your current app:

    heroku config:add BUILDPACK_URL=https://github.com/ojengwa/heroku-buildpack-nodejs-grunt-sass.git
